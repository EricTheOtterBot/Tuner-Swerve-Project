...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Limelight TX", LimelightHelpers.getTX("limelight-otto"));
        ...
        SmartDashboard.putNumber("Swerve Drive Pose X", this.getState().Pose.getX());
        SmartDashboard.putNumber("Swerve Drive Pose Y?", this.getState().Pose.getY());
