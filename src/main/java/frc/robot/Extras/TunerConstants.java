...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(21).withKI(0).withKD(0.16)
        .withKS(0.105).withKV(0).withKA(0)
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.21);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.40625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.061767578125);
